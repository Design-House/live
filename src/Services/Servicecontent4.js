...
const Servicecontent4 = () => {
    ...
    return (
        <div className='mb-5'>
          <h5 class="lg-txt lh-40 mt-5">We specialise in shaping your vision of the future by identifying
and cultivating innovative experiences, products, and services
that seamlessly integrate with the ever-evolving landscape of
customer journeys and business models.</h5>
        
        <div className='headplus-list mt-5 mb-5'>
            <h4>Future trend analysis</h4>
...
We don’t predict the future; we co-create it with you. Let’s craft a future that aligns perfectly with your aspirations and the ever-changing landscape
of possibilities. Contact us today to embark on this exciting journey of foresight and innovation!</p>
        </div>
